...
public class CreateApplicantBootcampContentCommand
    : IRequest<CreatedApplicantBootcampContentResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class CreateApplicantBootcampContentCommandHandler
        : IRequestHandler<CreateApplicantBootcampContentCommand, CreatedApplicantBootcampContentResponse>
    {
        ...
        public CreateApplicantBootcampContentCommandHandler(
            IMapper mapper,
        ...
        public async Task<CreatedApplicantBootcampContentResponse> Handle(
            CreateApplicantBootcampContentCommand request,
        ...
        )
        {
            ...
            CreatedApplicantBootcampContentResponse response = _mapper.Map<CreatedApplicantBootcampContentResponse>(
