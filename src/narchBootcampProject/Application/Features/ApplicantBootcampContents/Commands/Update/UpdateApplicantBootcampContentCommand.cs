...
public class UpdateApplicantBootcampContentCommand
    : IRequest<UpdatedApplicantBootcampContentResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class UpdateApplicantBootcampContentCommandHandler
        : IRequestHandler<UpdateApplicantBootcampContentCommand, UpdatedApplicantBootcampContentResponse>
    {
        ...
        public UpdateApplicantBootcampContentCommandHandler(
            IMapper mapper,
        ...
        public async Task<UpdatedApplicantBootcampContentResponse> Handle(
            UpdateApplicantBootcampContentCommand request,
        ...
        )
        {
            ...
            UpdatedApplicantBootcampContentResponse response = _mapper.Map<UpdatedApplicantBootcampContentResponse>(
                applicantBootcampContent
            );
            return response;
        }
