...
public class GetByIdApplicantBootcampContentQuery : IRequest<GetByIdApplicantBootcampContentResponse>, ISecuredRequest
{
    ...
    public class GetByIdApplicantBootcampContentQueryHandler
        : IRequestHandler<GetByIdApplicantBootcampContentQuery, GetByIdApplicantBootcampContentResponse>
    {
        ...
        public GetByIdApplicantBootcampContentQueryHandler(
            IMapper mapper,
        ...
        public async Task<GetByIdApplicantBootcampContentResponse> Handle(
            GetByIdApplicantBootcampContentQuery request,
        ...
        )
        {
            ...
            GetByIdApplicantBootcampContentResponse response = _mapper.Map<GetByIdApplicantBootcampContentResponse>(
                applicantBootcampContent
            );
            return response;
        }
