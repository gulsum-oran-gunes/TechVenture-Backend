...
public class UpdateApplicantPasswordCommand : IRequest<UpdateApplicantPasswordResponse>
{
    ...
    public class UpdateApplicantPasswordCommandHandler
        : IRequestHandler<UpdateApplicantPasswordCommand, UpdateApplicantPasswordResponse>
    {
        ...
        public UpdateApplicantPasswordCommandHandler(
