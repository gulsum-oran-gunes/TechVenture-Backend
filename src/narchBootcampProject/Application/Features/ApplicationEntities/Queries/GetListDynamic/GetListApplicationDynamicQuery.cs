...
public class GetListApplicationDynamicQuery : IRequest<GetListResponse<GetListApplicationEntityListItemDto>> /*, ISecuredRequest*/
{
    ...
    public class GetListApplicationDynamicQueryHandler
        : IRequestHandler<GetListApplicationDynamicQuery, GetListResponse<GetListApplicationEntityListItemDto>>
    {
