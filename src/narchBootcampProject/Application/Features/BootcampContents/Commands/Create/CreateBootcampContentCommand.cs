...
public class CreateBootcampContentCommand
    : IRequest<CreatedBootcampContentResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class CreateBootcampContentCommandHandler
        : IRequestHandler<CreateBootcampContentCommand, CreatedBootcampContentResponse>
    {
        ...
        public CreateBootcampContentCommandHandler(
            IMapper mapper,
        ...
        public async Task<CreatedBootcampContentResponse> Handle(
            CreateBootcampContentCommand request,
