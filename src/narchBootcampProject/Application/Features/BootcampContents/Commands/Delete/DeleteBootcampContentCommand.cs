...
public class DeleteBootcampContentCommand
    : IRequest<DeletedBootcampContentResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class DeleteBootcampContentCommandHandler
        : IRequestHandler<DeleteBootcampContentCommand, DeletedBootcampContentResponse>
    {
        ...
        public DeleteBootcampContentCommandHandler(
            IMapper mapper,
        ...
        public async Task<DeletedBootcampContentResponse> Handle(
            DeleteBootcampContentCommand request,
