...
public class UpdateBootcampContentCommand
    : IRequest<UpdatedBootcampContentResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class UpdateBootcampContentCommandHandler
        : IRequestHandler<UpdateBootcampContentCommand, UpdatedBootcampContentResponse>
    {
        ...
        public UpdateBootcampContentCommandHandler(
            IMapper mapper,
        ...
        public async Task<UpdatedBootcampContentResponse> Handle(
            UpdateBootcampContentCommand request,
