...
public class GetListBootcampContentQuery : IRequest<GetListResponse<GetListBootcampContentListItemDto>> // ISecuredRequest, ICachableRequest
{
    ...
    public class GetListBootcampContentQueryHandler
        : IRequestHandler<GetListBootcampContentQuery, GetListResponse<GetListBootcampContentListItemDto>>
    {
        ...
        public GetListBootcampContentQueryHandler(
        ...
        public async Task<GetListResponse<GetListBootcampContentListItemDto>> Handle(
            GetListBootcampContentQuery request,
