...
namespace Persistence.Migrations
{
    ...
    public partial class bootcampcontent : Migration
    {
        ...
        {
            migrationBuilder.AddColumn<string>(name: "ImageUrl", table: "Instructors", type: "nvarchar(max)", nullable: true);

            migrationBuilder.AddColumn<DateTime>(name: "Deadline", table: "Bootcamps", type: "datetime2", nullable: true);

            migrationBuilder.AddColumn<string>(name: "Detail", table: "Bootcamps", type: "nvarchar(max)", nullable: true);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 135, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "BootcampContents.Delete", null },
                    {
                        ...
                        null,
                        "ApplicantBootcampContents.Admin",
                        null
                    },
                    {
                        137,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        "ApplicantBootcampContents.Read",
                        null
                    },
                    {
                        138,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        "ApplicantBootcampContents.Write",
                        null
                    },
                    {
                        139,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        "ApplicantBootcampContents.Create",
                        null
                    },
                    {
                        140,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        "ApplicantBootcampContents.Update",
                        null
                    },
                    {
                        141,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        "ApplicantBootcampContents.Delete",
                        null
                    }
                }
            );
            ...
            migrationBuilder.CreateIndex(name: "IX_BootcampContents_BootcampId", table: "BootcampContents", column: "BootcampId");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "ApplicantBootcampContents");

            migrationBuilder.DropTable(name: "BootcampContents");

            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 115);

            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 116);

            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 117);

            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 118);

            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 119);
            ...
            migrationBuilder.DeleteData(table: "OperationClaims", keyColumn: "Id", keyValue: 126);
            ...
            migrationBuilder.DropColumn(name: "ImageUrl", table: "Instructors");

            migrationBuilder.DropColumn(name: "Deadline", table: "Bootcamps");

            migrationBuilder.DropColumn(name: "Detail", table: "Bootcamps");
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("39fd3134-d80b-4bed-99b5-2ab286f8f2df"),
                        0,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        null,
                        null,
                    ...
                    {
                        new Guid("3f7dfb50-7790-4c41-ada0-7ec11bdaa738"),
                        0,
                        new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        new DateTime(2024, 5, 7, 22, 2, 48, 251, DateTimeKind.Local).AddTicks(4028),
                        null,
                        "admin@mail",
                        "Admin",
                        "Oran",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    new Guid("2275b8d8-e0e5-428f-b3af-0540c33e48e4"),
                    new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                    null,
                    1,
                    null,
